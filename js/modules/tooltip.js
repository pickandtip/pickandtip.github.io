...
window.TooltipModule = (function() {
     ...
     * @param {string} [config.position='right'] - 'left' or 'right' - where tooltip appears
     * @param {boolean} [config.iconFirst=false] - true = icon before content, false = content before icon
    ...
    function createTooltipCell(config) {
        ...
        const iconHtml = `<span class="info-icon smart-tooltip-icon ${iconClass}${emptyClass}" data-position="${position}">
                    ⓘ
